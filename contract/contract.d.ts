...
export interface HypothesisWire {
  ...
  /**
   * Signal or contrast that would decide this, e.g. 'attention.image_token_ratio' or 'prompt_contrast describe_first'. M4 routes on it; M1 re-probes on it. EMPTY means the judge proposed none — see `is_routable`.
   */
  test_design?: string;
  status?: HypothesisStatus;
  /**
...
export interface StageStatus {
  stage: "pre_m1" | "m1" | "explore" | "m2" | "m3" | "m5_surgery" | "m5_fix" | "m4";
  state: StageState;
  /**
...
export interface HypothesisTestInput {
  ...
  protocol?: ProtocolWire | null;
  /**
   * Which partition M4 actually ran on. 'explore' means the hypotheses were generated on these same cases — an in-sample adjudication, not held-out.
   */
