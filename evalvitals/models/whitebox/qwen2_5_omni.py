...
Same pattern as :mod:`evalvitals.models.whitebox.qwen_omni`: a thin wrapper over
``compose(spec, "hf_local")`` (via :func:`evalvitals.load`); identity lives in
:mod:`evalvitals.specs`. Registered separately from the Qwen3-Omni family
...
its 300s audio-window truncation guard::
    ...
    from evalvitals.models.whitebox.qwen2_5_omni import qwen2_5_omni_7b
