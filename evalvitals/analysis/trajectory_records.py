...
`evalvitals explore` and :func:`~evalvitals.analysis.stats_tools.build_stats_input_from_records`
consume flat rows (``case_id`` + ``label`` + numeric signal columns).  This
module flattens each agent :class:`~evalvitals.core.case.Trajectory` into such
...
from evalvitals.core.case import FailureCase, Label, StepRole, Trajectory
