...
top of an audio run.  :func:`~evalrx.core.case.probed_modalities` answers
...
from evalrx.core.case import MEDIA_SLOTS, probed_modalities
...
def get_analyzer_catalog(model: "Model") -> dict[str, str]:
    ...
    :class:`~evalrx.eval_agent.probe_agent.ProbeAgent` to build the LLM
