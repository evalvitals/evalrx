...
1. **Statistical support** — do cases that exhibit the hypothesised signal fail
   ...
   clustered-bootstrap :func:`~evalrx.stats.compare` on the extracted
...
from evalrx.eval_agent.prompts.hypothesis_tester import _CONSISTENCY_PROMPT
from evalrx.eval_agent.stages.surgery import _extract_per_case_signals
...
class HypothesisTestResult:
    ...
    Attributes:
        ...
        status:                      Statistical verdict
                                     (:class:`~evalrx.eval_agent.hypothesis.HypothesisStatus`).
...
class HypothesisTester:
    ...
    Args:
        ...
        alpha:       Statistical significance level used for the e-value /
                     ...
                     :func:`~evalrx.stats.compare` and for confidence
                     scaling.
    ...
    def _verdict_from_stats_results(
        ...
        from evalrx.analysis.stats_tools import _is_outcome_regrade
        ...
        from evalrx.analysis.stats_agent import _multiplicity_note
