...
The explorer (:class:`~evalrx.analysis.explorer.ExploratoryAnalysisAgent`)
is a free-form EDA coder: it only knows what the question tells it. This
template turns the run's :class:`~evalrx.eval_agent.stages.protocol.ExperimentProtocol`
