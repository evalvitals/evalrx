"""M5 — intervention and repair. Two different jobs under one number.
...
# ===========================================================================
# M5a — SurgeryAgent: verify the mechanism
# ===========================================================================
...
# ===========================================================================
# M5b — FixAgent: propose and validate repairs
# ===========================================================================

class FixInput(WireModel):
    """Repairs are attempted only on hypotheses M4 verified. ``max_tier`` bounds
