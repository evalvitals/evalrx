...
:class:`~evalrx.models.toolcodec.ToolCallCodec` (auto-selected).  Tool
...
from evalrx.core.tool import Tool, ToolCall, ToolResult
from evalrx.models.toolcodec import ToolCallCodec, codec_for
...
class APIToolHandlerExecutor:
    ...
    The handler is INJECTED (not imported here), keeping evalrx decoupled from
