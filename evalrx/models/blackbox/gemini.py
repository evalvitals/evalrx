...
``role="tool"`` results, via :class:`~evalrx.models.toolcodec.OpenAIToolCodec`
...
from evalrx.models.blackbox.base import BlackboxModel, Trace
...
class GeminiModel(BlackboxModel):
    ...
    Requires ``pip install google-genai`` (``evalrx[gemini]``).
    """
    ...
    def _genai(self):
        try:
            ...
            raise ImportError(
                ...
                "Install it with: pip install 'evalrx[gemini]'"
            ) from exc
