"""Subject-side tool implementations for the :class:`~evalrx.models.agent.Agent` loop.
...
* **structured results** — :class:`~evalrx.core.tool.ToolResult` with
  model-visible text, re-injectable images, and host-side ``meta`` that lands
  on the trajectory step.
"""

from evalrx.models.tools.perception import detect_tool, ocr_tool
from evalrx.models.tools.visual import zoom_in_tool
