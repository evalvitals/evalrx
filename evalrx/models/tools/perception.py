...
:class:`~evalrx.core.tool.ToolResult` outputs whose ``meta`` records what
actually ran.
...
from evalrx.models.tools.visual import _sanitize_bbox, _to_pil
...
def default_detect_engine(
    ...
    try:
        ...
        raise ImportError(
            ...
            "(pip install 'evalrx[local]'), or inject an engine via "
            "detect_tool(..., engine=...)."
        ) from exc
