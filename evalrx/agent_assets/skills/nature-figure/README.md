...
> **EvalRX adaptation notice (Apache-2.0 modification):** the canonical
...
> EvalRX dataviz palette, so agent-drawn figures, host plotly charts, and
...
> palette are authoritative. In EvalRX sandboxes, chart-type and palette
