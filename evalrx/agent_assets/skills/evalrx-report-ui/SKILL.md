---
name: evalrx-report-ui
description: Generate EvalRX exploratory results that read like diagnostic reports, not raw feature dumps.
---

# EvalRX Report/UI Contract

Use this skill whenever you produce EvalRX exploratory analysis JSON,
