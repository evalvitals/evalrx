...
Usage (direct):
    python examples/m1_m4/mllms_small_object/run.py
    python examples/m1_m4/mllms_small_object/run.py --max-data-cases 32
    python examples/m1_m4/mllms_small_object/run.py --textvqa-size-split all
