...
from . import audiocaps_hallu, chair, chartqa, gsm8k, hotpotqa, llm, mmau, pope, spatial457
...
TASKS: dict[str, Task] = {}
for _task in (chartqa.TASK, spatial457.TASK, *pope.TASKS, chair.TASK, mmau.TASK, audiocaps_hallu.TASK, *llm.TASKS, hotpotqa.TASK, gsm8k.TASK):
