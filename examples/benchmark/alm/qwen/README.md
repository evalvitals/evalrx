...
(`evalrx-bench-qwen`, stage `qwen` of
...
|---|---|---|---|---|
| `qwen3-omni-30b-a3b` | `qwen3-omni-30b-a3b-instruct` | — | 2 | ~66 GB BF16 (thinker + talker): device=auto over two 48 GB cards |
...
```bash
cd examples/benchmark/alm/qwen
