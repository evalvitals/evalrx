...
Audio-visual analogue of examples/m1_m5/deco_chair: an audio-visual
...
diagnosis and repair are the loop's own job.
    ...
    4. VLDiagnoseLoop M1->M4             (M1 pinned to PINNED_M1_ANALYZERS, see below)
...
# too -- same reasoning as examples/m1_m5/mmau_qwen2_audio/run.py: their
