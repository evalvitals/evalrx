...
smoke-testing the M1-M5 loop wiring on hosts that cannot fit the real 17GB
...
# ---------------------------------------------------------------------------
# Mock model — proves the M1-M5 wiring without loading real weights
# ---------------------------------------------------------------------------
...
class MockAVModel(Model):
    ...
    needs to exercise its code paths (M1 probes, M2 stats, M3 diagnosis, M5
