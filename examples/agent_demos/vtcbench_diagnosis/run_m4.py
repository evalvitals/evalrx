"""VTC-Bench agent diagnosis — M4: paired fix experiments for the confirmed causes.
...
Usage:
    .venv/bin/python examples/agent_demos/vtcbench_diagnosis/run_m4.py
"""
...
def main() -> None:
    ...
    out_path = os.path.join(args.out, "m4_report.json")
